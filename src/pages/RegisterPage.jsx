...
import { UserPlus, ChevronRight, Lock, Mail, User, Sparkles, Code, Zap } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="relative bg-gradient-to-br from-slate-900/95 to-slate-800/95 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm">Join CodeClash and start competing</p>
          </div>
          ...
          <form onSubmit={submit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className={`relative ${focusedField === 'name' ? 'ring-2 ring-blue-500/50' : ''} rounded-xl transition-all`}>
